    ...
    build: {
        ...
        rollupOptions: {
            input: {
                ...
                bunkerBilder: "./bunkerBilder.html",
                flurBilder: "./flurBilder.html",
                heizungBilder: "./heizungBilder.html",
                treppeBild: "./treppeBild.html",
                tourGuide: "./tourGuide.html",
                tourGuideMenue: "./tourGuideMenue.html",
                tourGuideMenueHR: "./tourGuideMenueHR.html",
                bibInhaltEins: "./bib_einheit1_inhalt.html",
                bibInhaltEinsTest: "./bibEinheitEinsInhalt.html",
                ...getMapsScripts(maps),
            },
        },
    },
